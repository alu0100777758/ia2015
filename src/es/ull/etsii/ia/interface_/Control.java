...
public final class Control {
	...
	/**
	 * mï¿½todo que construye la interfaz.
	 */
	...
	/**
	 * mï¿½todo encargado de inicializar los diferentes gestores de eventos.
	 */
	...
	/**
	 * Mï¿½todo que desarrolla todos los pasos necesarios para lanzar la
	 * aplicaciï¿½n tal como se define.
	 */
	public void play() {
		buildInterface();
		setEventManagers();
	...
	/**
	 * @param point
	 *            punto donde se ha detectado un click mï¿½todo lanzado por el
	 *            gestor de eventos del ratï¿½n a fin de situar la posiciï¿½n
	 *            inicial del camino en base a la posiciï¿½n del ratï¿½n.
	 */
	...
	/**
	 * mï¿½todo encargado de avanzar a una posicion aleatoria factible para el
	 * camino actual.
	 */
...
//		}
	...
	/**
	 * @return Color mï¿½todo que devuelve el color seleccionado por el usuario
	 *         desde un dialogo de selecciï¿½n de color.
	 */
